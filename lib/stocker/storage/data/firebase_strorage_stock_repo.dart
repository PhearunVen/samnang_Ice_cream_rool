...
class FirebaseStrorageStockRepo implements StorageRepo {
  final FirebaseStorage storage = FirebaseStorage.instance;
  @override
  Future<String?> uploadfileImageMobile(String path, String fileName) {
    return _uploadFile(path, fileName, "product_images");
  }

  @override
  Future<String?> uploadfileImageWeb(Uint8List fileBytes, String fileName) {
    return _uploadFileBytes(fileBytes, fileName, "product_images");
  }
